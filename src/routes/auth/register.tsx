  ...
  return (
    <AuthShell title="Create your account" subtitle="Get a free VoltPass account in seconds">
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <div className="space-y-2"><Label>Organization (optional)</Label><Input value={form.org} onChange={(e) => setForm({ ...form, org: e.target.value })} /></div>
        ...
        <Button type="submit" disabled={loading} className="w-full bg-gradient-to-r from-primary to-electric-glow text-primary-foreground">
      ...
      <Button variant="outline" onClick={onGoogle} className="w-full">Continue with Google</Button>
