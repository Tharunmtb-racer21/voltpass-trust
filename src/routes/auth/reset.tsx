...
function Reset() {
  ...
  return (
    <AuthShell title="Set new password" subtitle={ready ? "Enter a new password" : "Validating link…"}>
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <Button type="submit" disabled={!ready} className="w-full bg-gradient-to-r from-primary to-electric-glow text-primary-foreground">Update password</Button>
      </form>
    </AuthShell>
  );
}
